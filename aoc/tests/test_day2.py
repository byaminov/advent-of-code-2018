...
class TestSolution(unittest.TestCase):
    ...
    def test_solve1(self):
        self.assertEqual(12, solve1('''abcdef
bababc
abbcde
abcccd
aabcdd
abcdee
ababab'''))
        self.assertEqual(5704, solve1(text))

    def test_solve2(self):
        self.assertEqual('fgij', solve2('''abcde
fghij
klmno
pqrst
fguij
axcye
wvxyz'''))
        self.assertEqual('umdryabviapkozistwcnihjqx', solve2(text))


text = '''umdryebvlapkozostecnihjexg
