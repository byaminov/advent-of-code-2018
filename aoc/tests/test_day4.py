...
class TestSolution(unittest.TestCase):
    ...
    def test_solve1(self):
        self.assertEqual(240, solve1('''[1518-11-01 00:00] Guard #10 begins shift
...
[1518-11-05 00:55] wakes up'''))
        self.assertEqual(39422, solve1(text))

    def test_solve2(self):
        self.assertEqual(4455, solve2('''[1518-11-01 00:00] Guard #10 begins shift
[1518-11-01 00:25] wakes up
[1518-11-01 00:05] falls asleep
[1518-11-01 00:30] falls asleep
[1518-11-01 00:55] wakes up
...
[1518-11-05 00:45] falls asleep
[1518-11-05 00:55] wakes up'''))
        self.assertEqual(65474, solve2(text))


text = '''[1518-05-12 00:46] wakes up
